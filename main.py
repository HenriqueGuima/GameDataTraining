...
def main():
    ...
    # Train the model
    stepsPerEpoch = np.ceil(len(trainSetX) / batchSize)
    validationSteps = np.ceil(len(valSetX) / batchSize)
    ...
    # Ensure stepsPerEpoch and validationSteps are integers
    stepsPerEpoch = int(stepsPerEpoch)
    validationSteps = int(validationSteps)
